...
vps="aneka";
	...
	#source="http://"
#else
	source="https://raw.githubusercontent.com/sktaka/ttt"
#fi
...
echo "<pre>Modified by TTTT</pre>" > /home/vps/public_html/index.html
...
echo "mail:TTT" | chpasswd
useradd -s /bin/false -M TTT
echo "ID:TTT" | chpasswd
# finishing
...
# info
clear
echo "Autoscript Edited BY TTT" | tee log-install.txt
